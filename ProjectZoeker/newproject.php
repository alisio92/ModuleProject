    ...
    <div id="content">
        <form id="new" method="post">
            ...
            <section id="label">
                ...
                <p><label for="img1"><?php echo $project_img; ?></label></p>
                <p><label for="img2"><?php echo $project_img; ?></label></p>
                <p><label for="img3"><?php echo $project_img; ?></label></p>
                <p><label for="img4"><?php echo $project_img; ?></label></p>
                <p><label for="img5"><?php echo $project_img; ?></label></p>
            </section>
            <section id="field">
                ...
                <div class="img">
                    <p><input type="text" placeholder="<?php echo $project_img; ?>" id="img1" name="img1"/></p>
                    <p><button value="<?php echo $button_img; ?>"><?php echo $button_img; ?></button></p>
                </div>

                <div class="img">
                    <p><input type="text" placeholder="<?php echo $project_img; ?>" id="img2" name="img2"/></p>
                    <p><button value="<?php echo $button_img; ?>"><?php echo $button_img; ?></button></p>
                </div>

                <div class="img">
                    <p><input type="text" placeholder="<?php echo $project_img; ?>" id="img3" name="img3"/></p>
                    <p><button value="<?php echo $button_img; ?>"><?php echo $button_img; ?></button></p>
                </div>

                <div class="img">
                    <p><input type="text" placeholder="<?php echo $project_img; ?>" id="img4" name="img4"/></p>
                    <p><button value="<?php echo $button_img; ?>"><?php echo $button_img; ?></button></p>
                </div>

                <div class="img">
                    <p><input type="text" placeholder="<?php echo $project_img; ?>" id="img5" name="img5"/></p>
                    <p><button value="<?php echo $button_img; ?>"><?php echo $button_img; ?></button></p>
                </div>
            </section>
