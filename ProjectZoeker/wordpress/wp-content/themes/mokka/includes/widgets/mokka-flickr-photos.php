...
class Mokka_Flickr_Feeds extends WP_Widget {
	...
	**/
	public function __construct() {
		...
		parent::__construct(
	 		'mokka_flickr_feeds', // Base ID
			__( 'Mokka: Flickr',  'favethemes'  ), // Name
			...
			if($person->user->id) {
				...
				<div class="flickr-widget">
                    ...
                    <?php foreach($photos->photos->photo as $photo): $photo = (array) $photo; ?>
                            ...
                            <a class="colored-bg inline-block" title="image" target='_blank' href="<?php echo $photos_url->user->url; ?><?php echo $photo['id']; ?>">
                                <img alt="<?php echo $photo['title']; ?>" title="<?php echo $photo['title']; ?>" src="<?php $url = "http://farm" . $photo['farm'] . ".static.flickr.com/" . $photo['server'] . "/" . $photo['id'] . "_" . $photo['secret'] . '_s' . ".jpg"; echo $url; ?>">
                            </a>
...
register_widget('Mokka_Flickr_Feeds');
?>