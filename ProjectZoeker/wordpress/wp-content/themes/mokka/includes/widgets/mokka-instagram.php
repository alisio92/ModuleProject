...
class mokka_instagram extends WP_Widget {
	...
	**/
	public function __construct() {
		...
		parent::__construct(
	 		'mokka_instagram', // Base ID
			__( 'Mokka: Instagram Slider',  'favethemes'  ), // Name
	...
	public function widget( $args, $instance ) {
		...
		echo $before_widget;
           ...
           // Get instagram data 
            ...
            if($template == "slider"){
			   $this->mokka_instagram_slider($template, $insta_data, $link_to, $unique_key);
			}
			elseif($template == "slider-overlay"){
				$this->mokka_instagram_slider_overlay($template, $insta_data, $link_to, $unique_key);
			}
			else{
				$this->mokka_instagram_slider_thumbs($template, $insta_data, $link_to);
			}
...
function mokka_instagram_slider($template, $insta_data, $link_to, $unique_key){?>
...
function mokka_instagram_slider_overlay($template, $insta_data, $link_to, $unique_key){?>
    ...
    <div class="widget-instagram-slider-<?php echo $unique_key; ?> instagram-overlay">
        ...
        if ( isset($insta_data) && is_array($insta_data) ) {
            foreach ($insta_data as $data) {
                ...
                echo '<div class="slide">'. "\n";
				echo '<a target="_blank" href="'.$link.'"><img src="'.$image.'" alt="'.$text.'"></a>' . "\n";
				echo '<div class="mokka-instagram-wrap">' . "\n";					
				echo '<div class="mokka-instagram-datacontainer">' . "\n";
				if ( $created_time ) {
					echo '<span class="mokka-instagram-time">'. human_time_diff( $created_time ) . __('ago',  'favethemes' ).'</span>' . "\n";
				}
				echo '<span class="mokka-instagram-username">by <a target="_blank" href="'. $user_url .'">'. $user_name .'</a></span>' . "\n";
				if ($text) {
					echo '<span class="mokka-instagram-desc">'.$text.'</span>' . "\n";
				}
				echo '</div>' . "\n";
				echo '</div>' . "\n";
				echo '</div>' . "\n";
...
function mokka_instagram_slider_thumbs($template, $insta_data, $link_to){?>
	
<div class="instagram-widget">
    <div class="inner-widget">
    	<ul class="mokka-instagram-thumbnails">
        <?php
            if ( isset( $insta_data ) && is_array( $insta_data ) ) {
                foreach ( $insta_data as $data ) {
                    foreach ( $data as $k => $v ) {
					...
					echo '<li>'. "\n";
                    echo '<a class="colored-bg inline-block" target="_blank" href="' . $link . '"><img src="' . $image . '" alt="' . $text . '"></a>' . "\n";
					echo '</li>' . "\n";
                }
            }
        ?>
...
register_widget( 'mokka_instagram' );
