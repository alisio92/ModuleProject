...
$of_options[] = array( 
					"name" => "Sticky Nav Logo",
					"desc" => "Upload logo for sticky nav. ",
					"id" => "sticky_nav_logo",
					"std" => "",
					"mod" => "min",
					"type" => "media"
...
$of_options[] = array( 	
					...
					"desc" => "Enter posts excerpt number of words. Will be use for all posts. Default: 70",
...
$of_options[] = array( 	
					"name" => "Date in posts",
					"desc" => "Enable or Disable date in posts. Default: Enable.",
					"id" => "site_date",
					"std" => 1,
					"on" => "Enable",
					"off" => "Disable",
...
$of_options[] = array( 	
					"name" => "Categories in posts",
					"desc" => "Enable or Disable categories in posts. Default: Enable.",
					"id" => "site_categories",
					"std" => 1,
					"on" => "Enable",
					"off" => "Disable",
...
$of_options[] = array( 	
					"name" => "Tags in posts",
					"desc" => "Enable or Disable tags in posts. Default: Enable.",
					"id" => "site_tags",
					"std" => 1,
					"on" => "Enable",
					"off" => "Disable",
...
$of_options[] = array( 	
					...
					"desc" => "",
					"id" => "developedby",
					"std" => "Copyright 2014 - All Right Reserved",
					"type" => "text"
				);
...
$of_options[] = array( 
					...
					"desc" => "Select a font family for main navigation. Default: Lato",
					"id" => "google_main_nav",
					"std" => 'Lato',
					"preview" => array(
...
$of_options[] = array( 
					...
					"desc" => "Select font family for titles and headings. Default: Prata",
...
$of_options[] = array( "name" => "Standard Fonts",
					"desc" => "",
					"id" => "font_size_intro",
					"std" => "<h1 style='margin: 0; color:#000;'>Font Sizes and Styles</h1>",
					"icon" => true,
					"type" => "info");		

				
$of_options[] = array( 	"name" 		=> "Main Menu Links Size",
						"desc" 		=> "Selected the font size for main menu main links. Default 17px.",
						"id" 		=> "main_menu_font_size_style",
						"std" 		=> array(
											'size'  => '17px',
											'style' => '700',
										),
...
$of_options[] = array( 	"name" 		=> "Top Menu Links Size",
						"desc" 		=> "Selected the font size for top menu main links. Default 14px.",
						"id" 		=> "top_menu_font_size_style",
						"std" 		=> array(
											'size'  => '14px',
											'style' => '700',
										),
...
$of_options[] = array(  "name" 		=> "Archive Page Layout. ",
						"desc" 		=> "Select archive pages ( Tags etc ) layout.",
						"id" => "archive_layout",
						"std" => "layout_4",
						"type" => "images",
						"options" => array(
							'layout_1' => $adminurl . 'layout-1.png',
							'layout_2' => $adminurl . 'layout-2.png',
							'layout_3' => $adminurl . 'layout-3.png',
							'layout_4' => $adminurl . 'layout-4.png',
							'layout_5' => $adminurl . 'layout-5.png'
					)
				);
...
$of_options[] = array( 	
					"name" => "Post Meta",
					"desc" => "Enable or Disable post meta. Default: Enable.",
					"id" => "single_post_meta",
					"std" => 1,
					"on" => "Enable",
					"off" => "Disable",
...
$of_options[] = array( 	
					"name" => "Post Tags",
					"desc" => "Enable or Disable post Tags. Default: Enable.",
					"id" => "single_tags",
					"std" => 1,
					"on" => "Enable",
					"off" => "Disable",
...
$related_random = array("1" => "Enable","0" => "Disable");
$of_options[] = array( 	
					"name" => "Related Posts as Random",
					"desc" => "Show random posts. Default: Disable",
					"id" => "related_random",
					"std" => "0",
					"type" => "radio",
...
/*==============================================================================
		Single Posts Default Layouts
*===============================================================================*/

$of_options[] = array(
					"name" => "Single Posts Default layout",
					"type" => "heading",
					"icon" => $adminurl . "icon-settings.png"
				);
...
$of_options[] = array( 	
					"name" => "Default Layout",
					"desc" => "Enable or Disable 'Single Posts' default layout. Default: Disable.",
					"id" => "on_off_single_default_layout",
					"std" => 0,
					"on" => "Enable",
					"off" => "Disable",
					"type" => "switch"
...
$of_options[] = array(  "name" 		=> "Single Posts Default layout. ",
						"desc" 		=> "Select single posts default layout. It will apply on all posts",
						"id" => "single_post_default_layout",
						"std" => "single-layout-4",
						"type" => "images",
						"options" => array(
							'single-layout-1' => $adminurl . 'layout-1.png',
							'single-layout-2' => $adminurl . 'layout-2.png',
							'single-layout-3' => $adminurl . 'layout-3.png',
							'single-layout-4' => $adminurl . 'layout-4.png'
...
$of_options[] = array( 	
					...
					"id" => "company_address",
					"std" => "2256 Jefferson Street #212 <br/> Miami Beach 33139, FL",
					"type" => "text"
				);
...
$footer_layout = array("three-column" => "Three Column","four-column" => "Four Column");
$of_options[] = array( 	
					"name" => "Footer layout",
					"desc" => "Choose footer layout. Default: Four Column",
					"id" => "footer_layout",
					"std" => "four-column",
					"type" => "radio",
